...
CREATE TABLE CONNECTION (
    ...
    athlete_a INT NOT NULL,
    athlete_b INT NOT NULL,
	creation_date DATETIME NOT NULL,
	CONSTRAINT FK_CONNECTION_ATHLETE_A FOREIGN KEY (athlete_a) REFERENCES ATHLETE(athlete_id),
	CONSTRAINT FK_CONNECTION_ATHLETE_B FOREIGN KEY (athlete_b) REFERENCES ATHLETE(athlete_id)
);

CREATE INDEX IDX_CONNECTION_ATHLETE ON CONNECTION (athlete_a, athlete_b);
...
CREATE INDEX IDX_ATHLETE_EVENT_TIME ON ATHLETE_EVENT (time);
